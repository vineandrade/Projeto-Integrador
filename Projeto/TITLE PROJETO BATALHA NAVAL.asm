...
.DATA
    ...
    REGRA0 DB "REGRAS:$"
    REGRA1 DB "O JOGO CONTA COM 5 EMBARCACOES AONDE VOCE IRA TENTAR DESTRUI-LAS$"
    REGRA2 DB "PARA ESCOLHER A POSIÇAO QUE DESEJA ATIRAR, VOCE DEVE INFORMAR A LETRA DA LINHA E O NUMERO DA COLUNA (EXP: D5)$"
    REGRA3 DB "SAO ELAS: ENCOURAÇADO, FRAGATA, SUBMARINO E O HIDROAVIAO$"
    REGRA4 DB "CASO ACERTE ALGUMA DELAS, SERA INFORMADO, CASO CONTRARIO 'AGUA'$"
    REGRA5 DB "CASO NAO QUEIRA MAIS JOGAR, APERTE A TECLA ESC NO TECLADO$"
    REGRA6 DB "APERTE ENTER PARA COMEÇAR$"
