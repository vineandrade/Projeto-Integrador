...
.DATA
    ...
    DIV_1   DB 218,196,196,196,194,196,196,196,194,196,196,196,194,196,196,196,194,196,196,196,194,196,196,196,194,196,196,196,194,196,196,196,194,196,196,196,194,196,196,196,194,196,196,196,194,196,196,196,194,196,196,196,194,196,196,196,194,196,196,196,194,196,196,196,194,196,196,196,194,196,196,196,194,196,196,196,194,196,196,196,191,"$"          ;Usando codigos ASCII para impressao
    DIV_2   DB 192,196,196,196,193,196,196,196,193,196,196,196,193,196,196,196,193,196,196,196,193,196,196,196,193,196,196,196,193,196,196,196,193,196,196,196,193,196,196,196,193,196,196,196,193,196,196,196,193,196,196,196,193,196,196,196,193,196,196,196,193,196,196,196,193,196,196,196,193,196,196,196,193,196,196,196,193,196,196,196,217,10,13,"$"     ;das matrizes utilizadas no jogo
    DIV_3   DB 195,196,196,196,197,196,196,196,197,196,196,196,197,196,196,196,197,196,196,196,197,196,196,196,197,196,196,196,197,196,196,196,197,196,196,196,197,196,196,196,197,196,196,196,197,196,196,196,197,196,196,196,197,196,196,196,197,196,196,196,197,196,196,196,197,196,196,196,197,196,196,196,197,196,196,196,197,196,196,196,180,10,13,"$" 
...
PRINTA_MATRIZ PROC          ;Funcao feita para a impressao da matriz que aparecera para o jogador 1 posicionar seus barcos
    ...
    MOV AH, 9               ; Função 9 para imprimir texto
LEA DX, COLUNAS         ; Carrega o endereço de COLUNAS no registrador DX
CALL IMPRIME_COLOR      ; Chama a função que imprime o texto com cor
INT 21H                 ; Imprime a numeração das colunas

BREAKS 2                ; Quebra de linha após imprimir as colunas
TAB 15                  ; Move o cursor para a coluna 15

GOTOXY 5, 45            ; Move o cursor para a posição (5, 45)
MOV AH, 9               ; Função 9 de interrupção 21h para imprimir um caractere
MOV CX, 1000            ; Define um grande número de repetições de espaços
MOV AL, ' '             ; Caractere de espaço
MOV BH, 0               ; Página 0
MOV BL, 00001001b       ; Cor do texto
INT 10H                 ; Chama a interrupção 10h para imprimir o caractere
MOV AH, 9               ; Função 9 de interrupção 21h para imprimir a string
LEA DX, DIV_1           ; Carrega a string de divisão
INT 21H                 ; Imprime a linha divisória

XOR DI, DI              ; Zera o índice DI
MOV CL, 20              ; Agora são 20 linhas
LACOA:
    XOR BX, BX          ; Zera o índice BX
    MOV CH, 20          ; Número de colunas (20)
    MOV AH, 9           ; Função 9 para imprimir um caractere
    LEA DX, ESPACE      ; Carrega o endereço do espaço
    INT 21H             ; Imprime o espaço
    TAB 45              ; Move o cursor para a coluna 45
    CMP CL, 20          ; Compara o contador de linhas com 20
    JE LACOB            ; Se for a última linha, vai para LACOB
    LEA DX, DIV_3       ; Carrega o endereço da string DIV_3 (uma linha divisória)
    INT 21H             ; Imprime a string DIV_3
    TAB 45              ; Move o cursor para a coluna 45

LACOB:
    MOV AH, 2           ; Função 2 para imprimir o caractere de linha 179
    MOV DL, 179         ; Define DL com o código do caractere de linha
    INT 21H             ; Imprime a linha
    MOV DL, 20H         ; Define DL como espaço
    INT 21H             ; Imprime o espaço
    MOV DL, MATRIZ1[DI+BX]  ; Carrega o valor da célula da matriz
    ADD DL, 30H         ; Converte o número para o formato ASCII
    INT 21H             ; Imprime o número
    MOV DL, 20H         ; Imprime um espaço após o número
    INT 21H             ; Imprime o espaço
    INC BX              ; Incrementa o índice de coluna
    DEC CH              ; Decrementa o contador de colunas
    JNZ LACOB           ; Repete o loop até imprimir todas as colunas

    MOV DL, 179         ; Imprime a linha final
    INT 21H
    ADD DI, 20          ; Avança para a próxima linha (incrementa 20 para a próxima linha)
    DEC CL              ; Decrementa o contador de linhas
    JNZ LACOA           ; Se CL não for 0, repete o loop

BREAKS 1                 ; Quebra de linha
TAB 45                   ; Move o cursor para a coluna 45

MOV AH, 9                ; Função 9 para imprimir o caractere
LEA DX, DIV_2            ; Carrega o endereço de DIV_2
INT 21H                  ; Imprime a linha divisória

GOTOXY 6, 43             ; Move o cursor para a posição (6, 43)
MOV AL, 65               ; Define o caractere 'A' para começar as linhas
RPT:
    MOV AH, 9            ; Função 9 para imprimir o caractere
    MOV BL, 00001011b     ; Define a cor do texto
    MOV CX, 1            ; Número de repetições
    INT 10h              ; Imprime o caractere
    MOVE_Y 2             ; Muda a linha
    INC AL               ; Avança para a próxima letra
    CMP AL, 85           ; Verifica se chegou à letra 'U' (para 20 linhas, que vai de A até T)
    JNE RPT              ; Se não chegou à 'T', repete o loop
